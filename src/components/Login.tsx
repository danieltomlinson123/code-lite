  ...
  return (
    <div className="grid grid-cols-2 items-center h-full w-full">
        ...
        >
          <input
            type="email"
            className="text-black rounded-lg relative border border-stone-300 px-5 pt-3 pb-2 text-stone-900 placeholder-stone-300 focus:z-10 focus:border-vinci focus:outline-none focus:ring-vinci text-lg"
            onChange={(e) => {
          ...
          <input
            type="password"
            className="mt-4 text-black relative rounded-lg border border-stone-300 px-5 pt-3 pb-2 text-stone-900 placeholder-stone-300 focus:z-10 focus:border-vinci focus:outline-none focus:ring-vinci text-lg"
            onChange={(e) => {
          ...
          <div className="flex items-center">
            <input id="remember-me" name="remember-me" type="checkbox" className="h-4 w-4 rounded-lg py-4 border-stone-300 text-vinci focus:ring-vinci-light" />
          ...
          <input className="font-oakesMedium mt-6 hover:bg-white/20 cursor-pointer rounded-lg bg-vinci hover:bg-vinci-hover text-lg pt-3 pb-2 text-white font-semibold" type="submit" value="Continue"/>
        </form>
