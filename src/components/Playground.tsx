...
>
  <input
    type="email"
    className="text-black rounded-lg relative border border-stone-300 px-5 py-3 text-stone-900 placeholder-stone-400 focus:z-10 focus:border-vinci focus:outline-none focus:ring-vinci text-lg"
    onChange={(e) => {
  ...
  <input
    type="password"
    className="mt-4 text-black relative rounded-lg border border-stone-300 px-5 py-3 text-stone-900 placeholder-stone-400 focus:z-10 focus:border-vinci focus:outline-none focus:ring-vinci text-lg"
    onChange={(e) => {
...
{/* this margin top is not changing */}
  <input className="mt-6 hover:bg-white/20 cursor-pointer rounded-lg bg-vinci hover:bg-vinci-hover text-lg py-3 text-white font-semibold" type="submit" value="Continue"/>
</form>
...
<img src="../../image_geometric.png" alt="3D geometric shapes" className="bg-white justify-self-center max-h-full"/>
